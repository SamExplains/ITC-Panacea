...
<div class="ui sixteen wide column">
  ...
  <div class="bg-info p-3 mb-3 col-6 col-md-3" style="border-top-right-radius: 5rem">
    <img class="ui avatar image" src="{{ Auth::user()->photo }}">
    <span class="text-white font-weight-bold">{{ Auth::user()->name }} | <span class="font-weight-light">{{ Auth::user()->account }}</span></span>
  </div>

  <div class="ui reply form universal-box-shadow">
    <div class="field" id="replyField">
      <textarea id="responseTextArea" name="replyTA" type="responseTextArea" placeholder="Enter response here">{{ $faker->realText(1000) }}</textarea>
    </div>
